...
export const PlayPanelComponent: FC = () => {
		...
		>
			<div className={styles.panel_wrap}>
				<div className={styles.panel_top}>
					...
					<div className={styles.panel_close} onClick={closeHandler}>
						<svg
							width='16'
							height='16'
							viewBox='0 0 16 16'
				...
				<div className={styles.panel_player}>
					<Player src={state} poster={poster} />
				</div>
			</div>
		</div>
	)
